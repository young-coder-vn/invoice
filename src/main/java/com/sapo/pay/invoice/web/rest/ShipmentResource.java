...
import com.sapo.pay.invoice.domain.Shipment;
import com.sapo.pay.invoice.repository.ShipmentRepository;
import com.sapo.pay.invoice.service.ShipmentService;
import com.sapo.pay.invoice.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.sapo.pay.invoice.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
